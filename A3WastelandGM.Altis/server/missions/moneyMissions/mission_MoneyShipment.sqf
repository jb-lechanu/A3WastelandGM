	...
	[
		...
		[
			...
			[
				...
				[ // East Germany convoy
					["gm_gc_army_brdm2", "gm_gc_army_brdm2"], // Veh 1
					["gm_gc_army_btr60pb", "gm_gc_army_btr60pb"] // Veh 2
				],
				[ // poland convoy
					["gm_pl_army_brdm2", "gm_pl_army_brdm2"], // Veh 1
					["gm_pl_army_ot64a", "gm_pl_army_ot64a"] // Veh 2
				],
				[ // West Germany convoy
					["gm_ge_army_fuchsa0_engineer ", "gm_ge_army_fuchsa0_reconnaissance"], // Veh 1
					["gm_ge_army_luchsa1", "gm_ge_army_luchsa2"] // Veh 2
				]
			]
		],
		// Medium
		[
			...
			[
				...
				[ // East germany convoy
					["gm_gc_army_brdm2", "gm_gc_army_btr60pb"], // Veh 1
					["gm_gc_army_bmp1sp2", "gm_gc_army_pt76b"], // Veh 2
					["gm_gc_army_brdm2", "gm_gc_army_btr60pb"] // Veh 3
				],
				[ // danemark convoy
					["gm_dk_army_m113a1dk_command", "gm_dk_army_m113a1dk_engineer"], // Veh 1
					["gm_dk_army_m113a2dk", "gm_dk_army_m113a1dk_apc"], // Veh 2
					["gm_dk_army_bpz2a0", "gm_dk_army_m113a1dk_medic"] // Veh 3
				],
				[ // west germany convoy
					["gm_ge_army_luchsa1", "gm_ge_army_luchsa2"], // Veh 1
					["gm_ge_army_marder1a1a", "gm_ge_army_marder1a1plus", "gm_ge_army_marder1a2"], // Veh 2
					["gm_ge_army_m113a1g_apc_milan", "gm_ge_army_m113a1g_apc"] // Veh 3
				]
			]
		],
		// Hard
		[
			...
			[
				...
				[ // east convoy
					["gm_gc_army_btr60pb", "gm_gc_army_pt76b", "gm_gc_army_bmp1sp2"], // Veh 1
					["gm_gc_army_t55", "gm_gc_army_t55a", "gm_gc_army_t55ak", "gm_gc_army_t55am2", "gm_gc_army_t55am2b"], // Veh 2
					["gm_gc_army_btr60pb", "gm_gc_army_pt76b", "gm_gc_army_bmp1sp2"] // Veh 3
				],
				[ // poland convoy
					["gm_pl_army_ot64a", "gm_pl_army_bmp1sp2", "gm_pl_army_pt76b"], // Veh 1
					["gm_pl_army_t55", "gm_pl_army_t55a", "gm_pl_army_t55ak"], // Veh 2
					["gm_pl_army_ot64a", "gm_pl_army_bmp1sp2", "gm_pl_army_pt76b"] // Veh 3
				],
				[ // poland convoy
					["gm_dk_army_m113a2dk"], // Veh 1
					["gm_dk_army_Leopard1a3"], // Veh 2
					["gm_dk_army_m113a2dk"] // Veh 3
				],
				[ // west convoy
					["gm_ge_army_luchsa1", "gm_ge_army_luchsa2", "gm_ge_army_m113a1g_apc_milan"], // Veh 1
					["gm_ge_army_Leopard1a1", "gm_ge_army_Leopard1a1a1", "gm_ge_army_Leopard1a1a2", "gm_ge_army_Leopard1a1a3", "gm_ge_army_Leopard1a1a4", "gm_ge_army_Leopard1a3", "gm_ge_army_Leopard1a3a1", "gm_ge_army_Leopard1a3a2", "gm_ge_army_Leopard1a3a3", "gm_ge_army_Leopard1a5"], // Veh 2
					["gm_ge_army_Leopard1a1", "gm_ge_army_Leopard1a1a1", "gm_ge_army_Leopard1a1a2", "gm_ge_army_Leopard1a1a3", "gm_ge_army_Leopard1a1a4", "gm_ge_army_Leopard1a3", "gm_ge_army_Leopard1a3a1", "gm_ge_army_Leopard1a3a2", "gm_ge_army_Leopard1a3a3", "gm_ge_army_Leopard1a5"] // Veh 3
				]
		...
		[
			...
			[
				...
				[ // east convoy
					["gm_gc_army_t55", "gm_gc_army_t55a", "gm_gc_army_t55ak", "gm_gc_army_t55am2", "gm_gc_army_t55am2b"], // Veh 1
					["gm_gc_army_t55", "gm_gc_army_t55a", "gm_gc_army_t55ak", "gm_gc_army_t55am2", "gm_gc_army_t55am2b"], // Veh 2
					["gm_gc_army_zsu234v1"], // Veh 3
					["gm_gc_army_btr60pb", "gm_gc_army_pt76b", "gm_gc_army_bmp1sp2"] // Veh 4
				],
				[ // poland convoy
					["gm_pl_army_t55", "gm_pl_army_t55a", "gm_pl_army_t55ak"], // Veh 1
					["gm_pl_army_t55", "gm_pl_army_t55a", "gm_pl_army_t55ak"], // Veh 2
					["gm_pl_army_zsu234v1"], // Veh 3
					["gm_pl_army_ot64a", "gm_pl_army_bmp1sp2", "gm_pl_army_pt76b"] // Veh 4
				],
				[ // danemark convoy
					["gm_dk_army_Leopard1a3_des","gm_dk_army_Leopard1a3_win", "gm_dk_army_Leopard1a3_wdl"], // Veh 1
					["gm_dk_army_Leopard1a3_des","gm_dk_army_Leopard1a3_win", "gm_dk_army_Leopard1a3_wdl"], // Veh 2
					["gm_dk_army_Leopard1a3_des","gm_dk_army_Leopard1a3_win", "gm_dk_army_Leopard1a3_wdl"], // Veh 3
					["gm_dk_army_m113a2dk_wdl", "gm_dk_army_m113a2dk_win", "gm_dk_army_m113a2dk_un"] // Veh 4
				],
				[ // west convoy
					["gm_ge_army_luchsa1", "gm_ge_army_luchsa2", "gm_ge_army_m113a1g_apc_milan"], // Veh 1
					["gm_ge_army_Leopard1a1", "gm_ge_army_Leopard1a1a1", "gm_ge_army_Leopard1a1a2", "gm_ge_army_Leopard1a1a3", "gm_ge_army_Leopard1a1a4", "gm_ge_army_Leopard1a3", "gm_ge_army_Leopard1a3a1", "gm_ge_army_Leopard1a3a2", "gm_ge_army_Leopard1a3a3", "gm_ge_army_Leopard1a5"], // Veh 2
					["gm_ge_army_Leopard1a1", "gm_ge_army_Leopard1a1a1", "gm_ge_army_Leopard1a1a2", "gm_ge_army_Leopard1a1a3", "gm_ge_army_Leopard1a1a4", "gm_ge_army_Leopard1a3", "gm_ge_army_Leopard1a3a1", "gm_ge_army_Leopard1a3a2", "gm_ge_army_Leopard1a3a3", "gm_ge_army_Leopard1a5"], // Veh 3
					["gm_ge_army_gepard1a1"] // Veh 4
				]
			]
		]
	]
